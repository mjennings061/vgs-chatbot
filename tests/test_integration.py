...
from vgs_chatbot.gui.app import ChatbotApp
...
def sample_documents():
    ...
    return [
        Document(
            ...
            url="https://test.sharepoint.com/safety.pdf",
        ...
        Document(
            ...
            url="https://test.sharepoint.com/procedures.docx",
...
async def test_full_authentication_flow(mock_settings, sample_user):
    ...
    with patch('vgs_chatbot.gui.app.DatabaseManager') as mock_db_manager:
        ...
        with patch('vgs_chatbot.repositories.user_repository.UserRepository') as mock_user_repo, \
...
async def test_end_to_end_chat_flow(mock_settings, sample_user, sample_documents):
    ...
    with patch('vgs_chatbot.gui.app.DatabaseManager'), \
        ...
        response = app._generate_response("What are the safety procedures?")
